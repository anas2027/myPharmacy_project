...
class GetMyMedcineUseCase {
  ...
  GetMyMedcineUseCase({required this.medcineRepositry});
  Future<Either<Failure, List<MyMedcine>>> call({required String phId}) async {
    return await medcineRepositry.getMyMedcine(phId: phId);
  }
}
